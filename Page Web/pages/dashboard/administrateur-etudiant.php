...
?>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="sidebar">
>>>>>>> e96856e058b9f57ab1ded7be1829d79db5708b9d
...
>>>>>>> e96856e058b9f57ab1ded7be1829d79db5708b9d
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<tr><td>' . $id . '</td><td>' . $nom . '</td><td>' . $prenom . '</td><td id="notShow">' .  $dateDeNaissance . '</td><td id="notShow">' . $cNE . '</td><td id="notShow">' . $cIN . '</td><td id="notShow">' . $genre . '</td><td id="notShow">' . $Groupe . '</td><td id="notShow">' .  $Username . '</td><td><a href="#"><img src="../../pics/icons/Icon awesome-edit.png" alt=""></a></td>
